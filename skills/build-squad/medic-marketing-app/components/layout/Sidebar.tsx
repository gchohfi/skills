...
const navLinks = [
  ...
  { href: '/setup', label: 'Configurar Medico', icon: '⚙️' },
  { href: '/analise-perfil', label: 'Analise de Perfil', icon: '🔍' },
  { href: '/concorrencia', label: 'Concorrencia', icon: '📊' },
...
export default function Sidebar({ mobileOpen = false, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={[
          'fixed top-0 left-0 z-30 h-full w-64 bg-[#0a1628] text-white flex flex-col transition-transform duration-300',
